...
//   const convertQRCode = Number(decodedText , decodeResult)

//   console.log( `Code matched = ${ decodedText } ` ,  decodeResult ) ; 

//   document.getElementById("result").innerHTML =
//     '<span class="result">' + `${convertQRCode + convertQRCode}` + "</span>";
